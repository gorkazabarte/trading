...
inputs = {
  ...
  lambda_get_settings_name     = dependency.lambda.outputs.lambda_get_settings_name
  lambda_get_status_arn        = dependency.lambda.outputs.lambda_get_status_invoke_arn
  lambda_get_status_name       = dependency.lambda.outputs.lambda_get_status_name
